    ...
    def clean_amount(self):
        ...
        if amount < min_deposit_amount:
            raise forms.ValidationError(
                f'You need to deposit at least {min_deposit_amount} Rs'
            )
...
class WithdrawForm(TransactionForm):
    ...
    def clean_amount(self):
        ...
        if amount < min_withdraw_amount:
            raise forms.ValidationError(
                f'You can withdraw at least {min_withdraw_amount} Rs'
            )

        if amount > max_withdraw_amount:
            raise forms.ValidationError(
                f'You can withdraw at most {max_withdraw_amount} Rs'
            )

        if amount > balance:
            raise forms.ValidationError(
                f'You have {balance} Rs in your account. '
